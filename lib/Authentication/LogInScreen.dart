...
class _LogInScreenState extends State<LogInScreen> {
  ...
  Future<void> LoginApi() async {
    ...
    if (fcm_token != null && fcm_token.isNotEmpty) {
      ...
      var data = await Userapi.PostLogin(_emailController.text,
          _passwordController.text, fcm_token, tokentype);
      ...
      CustomSnackBar.show(
          context, "Failed to retrieve FCM token. Please try again.");
    }
  }
